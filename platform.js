            ...
            var o = n(53),
                ...
                c = function(e, t, n) {
                    ...
                    l.initialize = function() {
                            ...
                            var e = u.filter(function(e){return!(e in p)});e.length>0?l.boot(null,e):f.forEach(l.initWidget.bind(l))},l.loadAssets=function(t){t&&t.length&&t.filter(function(e){return d.indexOf(e)===-1}).forEach(function(t){var n=e.document.createElement("script");n.src=t,n.setAttribute("defer","defer"),n.setAttribute("charset","UTF-8"),e.document.head.appendChild(n),d.push(t)})},l.observe=function(){if(e.MutationObserver&&!c){var t={childList:!0,subtree:!0,characterData:!0},n=null;c=new MutationObserver(function(e){var t=function(e){l.requireWidget(l.getWidgetIdByElement(e)),l.addPlaceholder(e)};e.forEach(function(e){var o=function(e){var o=l.getWidgetsElements(e);o.forEach(t),o.length>0&&(n&&clearTimeout(n),n=setTimeout(function(){l.revise()},1e3))};Array.prototype.forEach.call(e.addedNodes,o)})}),c.observe(e.document,t)}},l.initialize()};e.exports=c},function(e,t,n){/*!


* domready(c) Dustin Diaz 2014 - License MIT *
    /!function(t,n){e.exports=n()}("domready",function(){var e,t=[],n=document,o=n.documentElement.doScroll,i="DOMContentLoaded",r=(o?/ ^ loaded | ^ c /: /^loaded|^i|^c/).test(n.readyState);
...
function(e, t) {
    function n(e, t, n) {
        ...
        t && (o.push("with  -
                    ...
                    eapps.AppsManager ",s=function(){var e=this,t={},n=[],s=[];e.initialize=function(){e.logError=o.withModule(a)},e.facade=function(){return new i(e)},e.register=function(n,o){if(t.name)return void e.logError('Application "
                    '+n+'
                    " is already registered');var i=new o;t[n]=new r(i),e.initWidgetsFromBuffer(n)},e.app=function(e){return t[e]},e.initWidget=function(t,o){var i=e.app(o.app);if(i){if(s.indexOf(t)!==-1)return;s.push(t),i.initWidget(t,o),e.sendExtensionPostMessage(t,o)}else n.push({element:t,config:o,initialized:!1})},e.initWidgetsFromBuffer=function(t){n&&n.length&&n.forEach(function(n){t!==n.config.app||n.initialized||(n.initialized=!0,e.initWidget(n.element,n.config))})},e.sendExtensionPostMessage=function(e,t){window.postMessage({method:"
                    postMessagePlatformWidget ",data:{settings:t.settings,app_slug:t.app,public_id:t.id,platform:"
                    eapps "}}," * ")},e.initialize()};e.exports=s},function(e,t){var n=function(e){var t=this;t.initialize=function(){},t.register=function(t,n){return e.register(t,n)},t.initialize()};e.exports=n},function(e,t){(function(t){var n=function(e){var n=this,o=!1,i=[],r=t.eappsCustomPlatformUrl||"
                    https: //apps.elfsight.com";n.initialize=function(){e.whenReady(n.ready.bind(n))},n.ready=function(){o=!0,n.initWidgetsFromBuffer()},n.initWidget=function(t,r){if(o){r.websiteUrl=window.location.host||"undefined";var a={websiteUrl:r.websiteUrl,deactivate:1===r.preferences.disable_widget,widgetId:r.id||null,widgetOrigin:"apps.elfsight.com",showElfsightLogo:!r.preferences.hide_elfsight_logo,owner:r.isOwner,platform:r.platform,freeLinkUrl:r.preferences.free_link_url,freeLinkAnchor:r.preferences.free_link_anchor};r.settings=[r.settings,a].reduce(function(e,t){return Object.keys(t).forEach(function(n){e[n]=t[n]}),e},{}),e.initWidget(t,r.settings,r),r.isOwner&&n.initToolbar(t,r)}else i.push({element:t,config:r,initialized:!1})},n.initToolbar=function(e,t){t.usageStatus=function(){var e="green";return t.percentage>=100&&(e="red"),t.percentage>=90&&t.percentage<100&&(e="orange"),e};var n=document.implementation.createHTMLDocument();n.body.innerHTML='<div class="eapps-widget-toolbar">
...
function(e, t, n) {
    ...
    function f(e, t) {
        ...
        o && (n += "
                ...
                ");var i=new Blob([n],{type:"
                text / css "}),r=e.href;e.href=URL.createObjectURL(i),r&&URL.revokeObjectURL(r)}var d={},g=function(e){var t;return function(){return"
                undefined "==typeof t&&(t=e.apply(this,arguments)),t}},h=g(function(){return/msie [6-9]/.test(self.navigator.userAgent.toLowerCase())}),b=g(function(){return document.head||document.getElementsByTagName("
                head ")[0];}),v=null,m=0,w=[];e.exports=function(e,t){t=t||{},"
                undefined "==typeof t.singleton&&(t.singleton=h()),"
                undefined "==typeof t.insertAt&&(t.insertAt="
                bottom ");var n=i(e);return o(n,t),function(e){for(var r=[],a=0;a<n.length;a++){var s=n[a],c=d[s.id];c.refs--,r.push(c)}if(e){var l=i(e);o(l,t)}for(var a=0;a<r.length;a++){var c=r[a];if(0===c.refs){for(var p=0;p<c.parts.length;p++)c.parts[p]();delete d[c.id]}}}};var y=function(){var e=[];return function(t,n){return e[t]=n,e.filter(Boolean).join("
                ")}}()}]);
